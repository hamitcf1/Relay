...
- Name: auth-flow.spec.ts >> Authentication & Security >> TC-AUTH-002: Unauthenticated access to /dashboard redirects to /login
- Location: tests/e2e/auth-flow.spec.ts:48:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/dashboard
Call log:
  - navigating to "http://localhost:5174/dashboard", waiting until "load"
