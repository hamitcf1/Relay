                    ...
                    >
                        <div className="space-y-4">
                            ...
                            <div className="group/input relative">
                                ...
                                <div className="absolute left-12 right-12 top-0 bottom-0 pointer-events-none flex items-center text-sm font-mono tracking-tight overflow-hidden select-none">
                                ...
                                <input
                                    ...
                                    className="w-full bg-white/5 border border-white/10 rounded-xl py-3.5 pl-12 pr-12 hide-password-text caret-white placeholder:text-zinc-400 focus:outline-none focus:bg-white/10 focus:border-primary/50 focus:ring-1 focus:ring-primary/50 transition-all duration-300 text-sm font-mono tracking-tight"
