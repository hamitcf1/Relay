                ...
                <div className="prose prose-sm prose-invert max-w-none">
                    <ReactMarkdown
                        ...
                        components={{
                            ...
                            code: ({ children }) => <code className="bg-black/30 px-1 rounded text-primary font-mono text-[12px]">{children}</code>,
                            blockquote: ({ children }) => <blockquote className="border-l-2 border-primary/50 pl-3 italic my-2 text-muted-foreground">{children}</blockquote>,
        ...
        >
            ...
            <div className="p-2">
                <button
                    ...
                    className="w-full flex items-center gap-2 px-3 py-2.5 rounded-xl border border-dashed border-primary/30 bg-primary/5 hover:bg-primary/10 hover:border-primary/50 transition-all text-xs text-primary font-medium cursor-pointer"
                >
                        ...
                        <div className="max-h-52 overflow-y-auto p-1.5 space-y-0.5 scrollbar-thin relative">
                            {MODELS.map(m => (
                                ...
                                >
                                    ...
                                    {selectedModel === m.id && <Check className="w-3 h-3 text-primary" />}
                                </button>
                            ))}
                        </div>
                    </motion.div>
                ...
                {isOpen && (
                    <>
                        ...
                        <motion.div
                            ...
                            transition={{ type: 'spring', damping: 25, stiffness: 300 }}
                            className={cn(
                                "fixed pointer-events-auto flex flex-col overflow-hidden bg-background/95 backdrop-blur-md shadow-2xl shadow-black/20",
                                // Mobile: Bottom Sheet
                        ...
                        >
                                ...
                                <div className="flex items-center gap-1">
                                    ...
                                    {!isPublic && (
                                        <Button
                                            variant="ghost"
                                            size="icon"
                                            className={cn("h-8 w-8 rounded-lg", showSettings ? "text-primary" : "text-muted-foreground hover:text-primary")}
                                    ...
                                    <div className="flex flex-col items-center justify-center h-full text-center px-6">
                                        ...
                                        <div className="grid grid-cols-2 gap-2 w-full mb-6">
                                            {(isPublic ? getSupportSuggestions(t) : getQuickSuggestions(t)).map((s, i) => (
                                                <motion.button
                                                    ...
                                                    className="text-left px-3 py-2.5 rounded-xl bg-muted/50 border border-border/30 hover:bg-muted/80 hover:border-primary/30 transition-all text-xs text-muted-foreground hover:text-foreground cursor-pointer"
                                                >
                                                    {s.label}
                                                </motion.button>
                                            ))}
                                        ...
                                        {!isPublic && (
                                            <div className="w-full text-left space-y-2 pt-2 border-t border-border/10">
                                                <p className="text-[10px] font-semibold text-primary uppercase tracking-wider mb-2">{t('ai.chat.expertiseTitle')}</p>
                            ...
                            <div className="shrink-0 p-3 border-t border-border/30 bg-muted/10">
                                            ...
                                            <div className="grid grid-cols-2 gap-1.5 p-2 rounded-xl bg-muted/30 border border-border/20">
                                                {(isPublic ? getSupportSuggestions(t) : getQuickSuggestions(t)).map((s, i) => (
                                                    <motion.button
                                                        ...
                                                        className="text-left px-2.5 py-2 rounded-lg bg-background/60 border border-border/20 hover:bg-primary/10 hover:border-primary/30 transition-all text-[11px] text-muted-foreground hover:text-foreground cursor-pointer"
                                                    >
                                                        {s.label}
                                                    </motion.button>
                                                ))}
                                ...
                                <div className="flex items-center gap-2 bg-background/80 border border-border/50 rounded-xl px-3 py-1.5 focus-within:ring-2 focus-within:ring-primary/30 focus-within:border-primary/50 transition-all">
                                    <button
