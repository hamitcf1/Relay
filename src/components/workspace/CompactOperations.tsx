...
export function CompactOperations({ activeModule, onModuleChange, onOpenShiftModule }: CompactOperationsProps) {
    ...
    const modules = useMemo(() => {
        ...
        const order = MODULE_REGISTRY.map((item) => item.id)
