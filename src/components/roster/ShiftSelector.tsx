...
export function ShiftSelector({ staffName, dayLabel, value, shifts, getLabel, getTone, emptyLabel, closeLabel, onSelect, onClose }: { staffName: string; dayLabel: string; value: string | null; shifts: string[]; getLabel: (shift: string) => string; getTone: (shift: string) => string; emptyLabel: string; closeLabel: string; onSelect: (shift: string | null) => void; onClose: () => void }) {
