...
const en: Translations = {
        ...
        'module.cashInfo': 'Касса и данные отеля',
        ...
        'module.attendance': 'Учёт рабочего времени',
        'operations.attendance.desc': 'Записи о начале, окончании смены и опозданиях',
        'attendance.clock.clockIn': 'Начать смену',
        'attendance.clock.working': 'На смене',
        'attendance.clock.titleIn': 'Зафиксировать начало смены',
        'attendance.clock.titleOut': 'Зафиксировать окончание смены',
        'attendance.clock.planned': 'Плановая смена',
        'attendance.clock.actual': 'Текущее время',
        'attendance.clock.declaredIn': 'Заявленное время начала',
        'attendance.clock.declaredOut': 'Заявленное время окончания',
        'attendance.clock.auditHelp': 'Заявленное время сохраняется вместе с отдельной неизменяемой серверной отметкой. Реальная отметка видна только GM.',
        'attendance.clock.invalidDeclaredTime': 'Укажите корректное заявленное время.',
        'attendance.clock.late': 'опоздание',
        'attendance.clock.excuseLabel': 'Причина опоздания',
        'attendance.clock.excusePlaceholder': 'Чётко укажите причину задержки…',
        'attendance.clock.excuseHelp': 'При опоздании причина обязательна и будет видна в отчёте GM.',
        'attendance.clock.permissionLabel': 'Получено разрешение руководителя?',
        'attendance.clock.permissionYes': 'Да, разрешение получено',
        'attendance.clock.permissionNo': 'Нет, разрешение не получено',
        'attendance.clock.permissionHelp': 'GM подтвердит или отклонит это заявление.',
        'attendance.clock.disciplinaryWarning': 'Если начало или окончание смены не зафиксировано, на сотрудника будет составлен служебный акт.',
        'attendance.clock.inDesc': 'Заявленное время начала и фактическая серверная отметка записываются отдельно.',
        'attendance.clock.outDesc': 'Заявленное время окончания и фактическая серверная отметка записываются отдельно.',
        'attendance.clock.confirmIn': 'Записать начало',
        'attendance.clock.confirmOut': 'Записать окончание',
        'attendance.clock.cancel': 'Отмена',
        'attendance.clock.failed': 'Не удалось сохранить запись. Повторите попытку.',
        'attendance.clock.duplicate': 'Начало этой смены уже зафиксировано.',
        'attendance.report.title': 'Отчёты по рабочему времени',
        'attendance.report.desc': 'Аудит начала, окончания смен и опозданий сотрудников ресепшена.',
        'attendance.report.total': 'Всего записей',
        'attendance.report.late': 'Опоздания',
        'attendance.report.active': 'На смене',
        'attendance.report.avgLate': 'Среднее опоздание',
        'attendance.report.pending': 'Ожидают решения',
        'attendance.report.search': 'Найти сотрудника…',
        'attendance.report.export': 'Скачать CSV',
        'attendance.report.employee': 'Сотрудник',
        'attendance.report.date': 'Дата / Смена',
        'attendance.report.planned': 'По графику',
        'attendance.report.clockIn': 'Начало',
        'attendance.report.clockOut': 'Окончание',
        'attendance.report.declaredClockIn': 'Заявленное начало',
        'attendance.report.actualClockIn': 'Фактическое начало',
        'attendance.report.declaredClockOut': 'Заявленное окончание',
        'attendance.report.actualClockOut': 'Фактическое окончание',
        'attendance.report.gmAuditNote': 'Фактические отметки времени являются неизменяемыми серверными записями и видны только GM.',
        'attendance.report.duration': 'Длительность',
        'attendance.report.status': 'Статус',
        'attendance.report.excuse': 'Причина',
        'attendance.report.permission': 'Разрешение руководителя',
        'attendance.report.onTime': 'Вовремя',
        'attendance.report.working': 'На смене',
        'attendance.report.completed': 'Завершено',
        'attendance.report.autoCompleted': 'Закрыто автоматически',
        'attendance.report.noExit': 'Окончание не отмечено',
        'attendance.report.permissionYes': 'Разрешение заявлено',
        'attendance.report.permissionNo': 'Без разрешения',
        'attendance.report.approvalPending': 'Ожидает решения GM',
        'attendance.report.approved': 'Подтверждено',
        'attendance.report.rejected': 'Отклонено',
        'attendance.report.approve': 'Подтвердить',
        'attendance.report.reject': 'Отклонить',
        'attendance.report.reviewTitleApprove': 'Подтвердить опоздание',
        'attendance.report.reviewTitleReject': 'Отклонить опоздание',
        'attendance.report.reviewDesc': 'Ваше решение, имя и время действия будут добавлены в журнал аудита.',
        'attendance.report.reviewNote': 'Комментарий руководителя',
        'attendance.report.reviewNotePlaceholder': 'Пояснение к решению…',
        'attendance.report.rejectionRequired': 'При отклонении комментарий руководителя обязателен.',
        'attendance.report.saveDecision': 'Сохранить решение',
        'attendance.report.empty': 'За выбранный период записей не найдено.',
        'attendance.report.access': 'Этот отчёт доступен только GM.',
        'attendance.report.shift': 'Смена {type}',
        'attendance.report.shiftLabel': 'Смена',
        'attendance.report.scheduledIn': 'Плановое начало',
        'attendance.report.scheduledOut': 'Плановое окончание',
        'attendance.report.lateMinutes': 'Минуты опоздания',
        'attendance.report.permissionDeclaration': 'Заявление о разрешении',
        'attendance.report.approvalStatus': 'Статус решения GM',
        'attendance.report.reviewedBy': 'Рассмотрел',
        'attendance.report.reviewedAt': 'Время решения',
        'attendance.report.workedMinutes': 'Минуты работы',
        'attendance.unit.hour': 'ч',
        'attendance.unit.minute': 'мин',
        'attendance.toast.clockIn': 'Начало смены записано',
        'attendance.toast.clockOut': 'Окончание смены записано',
        'attendance.toast.approved': 'Опоздание подтверждено',
        'attendance.toast.rejected': 'Опоздание отклонено',
        'activity.action.attendance_clock_in': 'Начало смены',
        'activity.action.attendance_clock_out': 'Окончание смены',
        'activity.action.attendance_review': 'Решение по разрешению',
}
