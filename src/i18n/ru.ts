...
const en: Translations = {
        ...
        'landing.deepdive.section1.desc': 'Open issues, pending payments and KBS checks roll over to the next shift in one structured handover screen with no missing context.',
        'landing.deepdive.section1.bullet1': 'Prioritized open-work tracking',
        ...
        'landing.compare.before.item4': 'Open work with no clear owner',
        ...
        'landing.compare.after.item4': 'Work records with clear ownership and history',
        ...
        'module.hotelInfo': 'Информация об отеле',
        'module.currencyConverter': 'Конвертер валют',
        ...
        'notifications.unreadBadge': 'непрочитанных: {count}',
        'notifications.allRead': 'Все прочитаны',
        'notifications.day.today': 'Сегодня',
        'notifications.day.yesterday': 'Вчера',
        'maintenance.title': 'Очередь обслуживания',
        'maintenance.subtitle': 'Всё, что сломано, в порядке срока.',
        'maintenance.openCount': 'Открыто: {count}',
        'maintenance.overdueCount': 'Просрочено: {count}',
        'maintenance.filter.label': 'Фильтр очереди',
        'maintenance.filter.open': 'Открытые',
        'maintenance.filter.resolved': 'Закрытые',
        'maintenance.filter.all': 'Все',
        'maintenance.emptyOpen': 'Открытых заявок нет. Всё работает.',
        'maintenance.emptyResolved': 'Закрытых заявок пока нет.',
        'maintenance.emptyAll': 'Заявок на обслуживание пока нет.',
        'maintenance.report.title': 'Сообщить о проблеме',
        'maintenance.report.submit': 'Добавить в очередь',
        'maintenance.room': 'Номер',
        'maintenance.roomPlaceholder': 'например, 204',
        'maintenance.roomLabel': 'Номер {room}',
        'maintenance.what': 'Что случилось?',
        'maintenance.whatPlaceholder': 'например, кондиционер в 204 не охлаждает.',
        'maintenance.priority': 'Приоритет',
        'maintenance.due': 'Срок',
        'maintenance.dueOn': 'Срок: {date}',
        'maintenance.overdue': 'Просрочено',
        'maintenance.reportedBy': 'Сообщил: {name}',
        'maintenance.assign': 'Назначить',
        'maintenance.unassigned': 'Не назначено',
        'maintenance.resolve': 'Отметить выполненной',
        'maintenance.reopen': 'Открыть снова',
        'maintenance.confirmResolve': 'Закрыть заявку',
        'maintenance.resolutionLabel': 'Что сделано:',
        'maintenance.resolutionPlaceholder': 'например, заменён компрессор.',
        'maintenance.gmOnly': 'Закрывать заявки может только руководитель.',
        'settings.desktopNotifications.title': 'Уведомления на рабочем столе',
        'settings.desktopNotifications.label': 'Показывать уведомления на рабочем столе',
        'settings.desktopNotifications.on': 'Новые уведомления показываются на рабочем столе.',
        'settings.desktopNotifications.off': 'Выключено. Уведомления видны только внутри приложения.',
        'settings.desktopNotifications.willAsk': 'При включении браузер запросит разрешение.',
        'settings.desktopNotifications.blocked': 'Браузер не разрешает эти уведомления.',
        'settings.desktopNotifications.blockedHint': 'Разрешите уведомления для этого сайта в настройках браузера и попробуйте снова.',
        'settings.desktopNotifications.unsupported': 'Этот браузер не поддерживает уведомления на рабочем столе.',
        'notifications.duePayments.title': 'Продажа без оплаты',
        'notifications.duePayments.room': 'комната {room}',
        'notifications.duePayments.amount': 'не собрано {amount} {currency}',
        'notifications.upcomingSaleReminder.title': 'Напоминание о продаже / трансфере на завтра',
        'notifications.upcomingSaleReminder.content': 'Запланировано на завтра: {name} · Номер: {room} · Гость: {guest} · Время: {time}',
        ...
        'personalNotes.desc': 'Сохраняйте идеи, добавляйте теги и делитесь ими с выбранными коллегами.',
        'personalNotes.add': 'Добавить заметку',
        'personalNotes.create': 'Создать заметку',
        'personalNotes.edit': 'Редактировать заметку',
        'personalNotes.form.title': 'Заголовок',
        'personalNotes.form.body': 'Заметка',
        'personalNotes.form.tags': 'Теги',
        'personalNotes.form.tagsHint': 'Разделяйте теги запятыми.',
        'personalNotes.share': 'Редактировать вместе',
        'personalNotes.shareHint': 'Выбранные люди смогут просматривать и редактировать заметку.',
        'personalNotes.ownBadge': 'Личная заметка',
        'personalNotes.sharedBadge': 'Общая заметка',
        'personalNotes.preview': 'Длина заметки',
        'personalNotes.unitWords': 'слов',
        'personalNotes.unitChars': 'символов',
        'personalNotes.noBody': 'Содержания нет',
        'personalNotes.clickToEdit': 'Нажмите на карточку, чтобы редактировать.',
        'personalNotes.updated': 'Обновлено',
        'personalNotes.created': 'Создано',
        'personalNotes.empty': 'В этом разделе заметок нет.',
        'personalNotes.createFirst': 'Создайте первую',
        'personalNotes.viewActive': 'Мои заметки',
        'personalNotes.viewShared': 'Общие',
        'personalNotes.viewArchived': 'Архив',
        'personalNotes.viewTrash': 'Корзина',
        'personalNotes.search': 'Поиск по заметкам',
        'personalNotes.searchPlaceholder': 'Заголовок, текст или тег',
        'personalNotes.allTags': 'Все теги',
        'personalNotes.copyBody': 'Копировать содержание',
        'personalNotes.copied': 'Содержание заметки скопировано.',
        'personalNotes.copyFailed': 'Не удалось скопировать.',
        'personalNotes.archive': 'В архив',
        'personalNotes.unarchive': 'Из архива',
        'personalNotes.moveToTrash': 'Удалить',
        'personalNotes.restore': 'Восстановить',
        'personalNotes.purge': 'Удалить навсегда',
        'personalNotes.unsaved': 'Несохранённые изменения',
        'personalNotes.allSaved': 'Все изменения сохранены',
        'personalNotes.saving': 'Сохранение',
        'personalNotes.saved': 'Заметка сохранена.',
        'personalNotes.saveFailed': 'Не удалось сохранить заметку.',
        'personalNotes.createFailed': 'Не удалось создать заметку.',
        'personalNotes.updateFailed': 'Не удалось обновить заметку.',
        'personalNotes.deleteFailed': 'Не удалось удалить заметку.',
        'personalNotes.loadFailed': 'Не удалось загрузить личные заметки.',
        'personalNotes.sharedLoadFailed': 'Не удалось загрузить общие заметки.',
        'personalNotes.demoBlocked': 'Личные заметки недоступны в демо-режиме.',
        'personalNotes.leaveConfirm': 'Отменить несохранённые изменения?',
        ...
        'sales.details.cancelledInfo': 'Эта продажа отменена; оплата больше не ожидается.',
        'sales.details.paymentNotTaken': 'Оплата не получена. Отметьте её как неполученную.',
        'sales.details.paymentTaken': 'По этой продаже была получена оплата. Верните её или оставьте как полученную.',
        'sales.details.markNotReceived': 'Отметить как Не Получено',
        'sales.details.refund': 'Возврат',
        'sales.details.refundConfirmTitle': 'Вернуть этот платёж?',
        'sales.details.refundConfirmDesc': 'Полученная оплата будет возвращена, а сумма обнулена.',
        ...
        'sales.payment.cancelled': 'Не Получено',
        'sales.payment.refunded': 'Возвращено',
        ...
        'onboarding.shift.desc': 'Follow the roster, complete KBS checks, and manage handover notes.',
        ...
        'ai.chat.internalWelcome': 'У меня есть доступ в реальном времени к операционным данным (графики, посещаемость, продажи, заметки передачи смены, туры и курсы валют). Я могу готовить отчёты и сводки по сменам.',
        ...
        'appearance.accent.slateBlue': 'Slate Blue',
        ...
        'announcement.title': 'Важное объявление',
        'announcement.deleteConfirm': 'Вы уверены, что хотите удалить это объявление?',
        'announcement.withdraw': 'Отозвать',
        'announcement.withdrawConfirm': 'Убрать объявление у всех? Те, кто уже прочитал его, получат уведомление об отзыве, и им будет напоминаться, пока они не подтвердят. Те, кто ещё не открывал объявление, ничего не увидят.',
        'announcement.withdrawn': 'Отозвано',
        'announcement.withdrawnBy': 'Отозвано: {name}',
        'announcement.restore': 'Опубликовать снова',
        'announcement.purge': 'Удалить навсегда',
        'announcement.purgeConfirm': 'Навсегда удалить объявление и отметки о прочтении? Это действие необратимо.',
        'announcement.insights': 'Кто видел?',
        'announcement.sentBy': 'Отправитель',
        'announcement.notSeenYet': 'Ещё не видели',
        'announcement.seen': 'Видели',
        'announcement.dismissed': 'Закрыли',
        'announcement.everyone': 'Все',
        'announcement.selectedCount': '{count} чел.',
