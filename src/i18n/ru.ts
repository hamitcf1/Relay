...
const en: Translations = {
        ...
        'attendance.clock.inDesc': 'Время начала смены сохраняется как неизменяемая запись аудита.',
        'attendance.clock.outDesc': 'Время окончания смены будет сохранено, а продолжительность работы рассчитана.',
