...
const tr: Translations = {
        ...
        'appearance.accent.slateBlue': 'Slate Mavi',
        ...
        'notifications.unreadBadge': '{count} okunmamış',
        'notifications.allRead': 'Hepsi okundu',
        'notifications.day.today': 'Bugün',
        'notifications.day.yesterday': 'Dün',
        'maintenance.title': 'Bakım kuyruğu',
        'maintenance.subtitle': 'Bozuk bildirilen her şey burada, terminine göre sıralı.',
        'maintenance.openCount': '{count} açık',
        'maintenance.overdueCount': '{count} gecikti',
        'maintenance.filter.label': 'Kuyruk filtresi',
        'maintenance.filter.open': 'Açık',
        'maintenance.filter.resolved': 'Kapalı',
        'maintenance.filter.all': 'Tümü',
        'maintenance.emptyOpen': 'Açık bakım kaydı yok. Her şey yolunda.',
        'maintenance.emptyResolved': 'Kapatılmış bakım kaydı yok.',
        'maintenance.emptyAll': 'Henüz bakım kaydı yok.',
        'maintenance.report.title': 'Arıza bildir',
        'maintenance.report.submit': 'Kuyruğa ekle',
        'maintenance.room': 'Oda',
        'maintenance.roomPlaceholder': 'Örn. 204',
        'maintenance.roomLabel': 'Oda {room}',
        'maintenance.what': 'Ne oluyor?',
        'maintenance.whatPlaceholder': 'Örn. 204 odasındaki klima çalışmıyor.',
        'maintenance.priority': 'Öncelik',
        'maintenance.due': 'Termin',
        'maintenance.dueOn': 'Termin: {date}',
        'maintenance.overdue': 'Gecikti',
        'maintenance.reportedBy': 'Bildiren: {name}',
        'maintenance.assign': 'Görevlendir',
        'maintenance.unassigned': 'Atanmadı',
        'maintenance.resolve': 'Çözüldü işaretle',
        'maintenance.reopen': 'Yeniden aç',
        'maintenance.confirmResolve': 'Kapat',
        'maintenance.resolutionLabel': 'Yapılan iş:',
        'maintenance.resolutionPlaceholder': 'Örn. Kompresör değiştirildi.',
        'maintenance.gmOnly': 'Kapatma yetkisi yöneticide.',
        'settings.desktopNotifications.title': 'Masaüstü Bildirimleri',
        'settings.desktopNotifications.label': 'Bildirimleri masaüstüne gönder',
        'settings.desktopNotifications.on': 'Yeni bildirimlerde masaüstü bildirimi gösterilir.',
        'settings.desktopNotifications.off': 'Kapalı. Bildirimler yalnızca uygulama içinde görünür.',
        'settings.desktopNotifications.willAsk': 'Açtığınızda tarayıcı izin isteyecek.',
        'settings.desktopNotifications.blocked': 'Tarayıcı bu bildirimlere izin vermiyor.',
        'settings.desktopNotifications.blockedHint': 'Tarayıcı ayarlarından bu siteye bildirim izni verin, sonra tekrar deneyin.',
        'settings.desktopNotifications.unsupported': 'Bu tarayıcı masaüstü bildirimlerini desteklemiyor.',
        'notifications.duePayments.title': 'Tahsil edilmemiş satış',
        'notifications.duePayments.room': 'oda {room}',
        'notifications.duePayments.amount': '{amount} {currency} tahsil edilmedi',
        'notifications.upcomingSaleReminder.title': 'Yarınki Satış / Transfer Hatırlatıcısı',
        'notifications.upcomingSaleReminder.content': 'Yarın gerçekleşecek: {name} · Oda: {room} · Misafir: {guest} · Saat: {time}',
        ...
        'announcement.retractionExpired': 'Geri alma bildirimi {count} kişiye ulaşmadı ve hatırlatma durdu. Bu kişilere ayrıca haber verin.',
        ...
        'personalNotes.desc': 'Fikirlerini sakla, etiketle ve seçtiğin ekip arkadaşlarınla paylaş.',
        'personalNotes.add': 'Yeni Not Ekle',
        'personalNotes.create': 'Yeni Not Oluştur',
        'personalNotes.edit': 'Notu Düzenle',
        'personalNotes.form.title': 'Başlık',
        'personalNotes.form.body': 'Not',
        'personalNotes.form.tags': 'Etiketler',
        'personalNotes.form.tagsHint': 'Etiketleri virgülle ayırın.',
        'personalNotes.share': 'Birlikte Düzenle',
        'personalNotes.shareHint': 'Seçtiğin kişiler bu notu görebilir ve düzenleyebilir.',
        'personalNotes.ownBadge': 'Kişisel Not',
        'personalNotes.sharedBadge': 'Paylaşımlı Not',
        'personalNotes.preview': 'Not Uzunluğu',
        'personalNotes.unitWords': 'kelime',
        'personalNotes.unitChars': 'karakter',
        'personalNotes.noBody': 'İçerik yok',
        'personalNotes.clickToEdit': 'Düzenlemek için karta tıklayın.',
        'personalNotes.updated': 'Güncellendi',
        'personalNotes.created': 'Oluşturuldu',
        'personalNotes.empty': 'Bu görünümde not yok.',
        'personalNotes.createFirst': 'İlkini oluştur',
        'personalNotes.viewActive': 'Notlarım',
        'personalNotes.viewShared': 'Paylaşılan',
        'personalNotes.viewArchived': 'Arşiv',
        'personalNotes.viewTrash': 'Çöp Kutusu',
        'personalNotes.search': 'Notlarda ara',
        'personalNotes.searchPlaceholder': 'Başlık, metin veya etiket ara',
        'personalNotes.allTags': 'Tüm etiketler',
        'personalNotes.copyBody': 'İçeriği kopyala',
        'personalNotes.copied': 'Not içeriği kopyalandı.',
        'personalNotes.copyFailed': 'Kopyalanamadı.',
        'personalNotes.archive': 'Arşivle',
        'personalNotes.unarchive': 'Arşivden çıkar',
        'personalNotes.moveToTrash': 'Sil',
        'personalNotes.restore': 'Geri al',
        'personalNotes.purge': 'Kalıcı sil',
        'personalNotes.unsaved': 'Kaydedilmemiş değişiklikler',
        'personalNotes.allSaved': 'Tüm değişiklikler kayıtlı',
        'personalNotes.saving': 'Kaydediliyor',
        'personalNotes.saved': 'Not kaydedildi.',
        'personalNotes.saveFailed': 'Not kaydedilemedi.',
        'personalNotes.createFailed': 'Not oluşturulamadı.',
        'personalNotes.updateFailed': 'Not güncellenemedi.',
        'personalNotes.deleteFailed': 'Not silinemedi.',
        'personalNotes.loadFailed': 'Kişisel notlar yüklenemedi.',
        'personalNotes.sharedLoadFailed': 'Paylaşılan notlar yüklenemedi.',
        'personalNotes.demoBlocked': 'Demo modunda kişisel not kaydı kullanılamıyor.',
        'personalNotes.leaveConfirm': 'Kaydedilmemiş değişiklikleri bırakmak istiyor musunuz?',
        ...
        'onboarding.shift.desc': 'Vardiya planını takip et, KBS kontrollerini yap ve devir notlarını yönet.',
        ...
        'landing.deepdive.section1.desc': 'Açık olaylar, bekleyen ödemeler ve KBS kontrolü tek bir yapılandırılmış devir ekranında bir sonraki vardiyaya geçer. Telefon turu yok, kayıp bilgi yok.',
        'landing.deepdive.section1.bullet1': 'Önceliklendirilmiş açık iş takibi',
        ...
        'landing.compare.before.item4': 'Sahibi belli olmayan açık işler',
        ...
        'landing.compare.after.item4': 'Sorumlusu ve geçmişi görünen iş kayıtları',
