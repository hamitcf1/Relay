...
const en: Translations = {
        ...
        'maintenance.title': 'Maintenance queue',
        'maintenance.subtitle': 'Everything reported broken, ordered by when it is due.',
        'maintenance.openCount': '{count} open',
        'maintenance.overdueCount': '{count} overdue',
        'maintenance.filter.label': 'Queue filter',
        'maintenance.filter.open': 'Open',
        'maintenance.filter.resolved': 'Closed',
        'maintenance.filter.all': 'All',
        'maintenance.emptyOpen': 'Nothing open. Everything is working.',
        'maintenance.emptyResolved': 'No closed tickets yet.',
        'maintenance.emptyAll': 'No maintenance tickets yet.',
        'maintenance.report.title': 'Report a problem',
        'maintenance.report.submit': 'Add to queue',
        'maintenance.room': 'Room',
        'maintenance.roomPlaceholder': 'e.g. 204',
        'maintenance.roomLabel': 'Room {room}',
        'maintenance.what': 'What is wrong?',
        'maintenance.whatPlaceholder': 'e.g. The air conditioning in 204 is not cooling.',
        'maintenance.priority': 'Priority',
        'maintenance.due': 'Due',
        'maintenance.dueOn': 'Due: {date}',
        'maintenance.overdue': 'Overdue',
        'maintenance.reportedBy': 'Reported by {name}',
        'maintenance.assign': 'Assign',
        'maintenance.unassigned': 'Unassigned',
        'maintenance.resolve': 'Mark resolved',
        'maintenance.reopen': 'Reopen',
        'maintenance.confirmResolve': 'Close ticket',
        'maintenance.resolutionLabel': 'What was done:',
        'maintenance.resolutionPlaceholder': 'e.g. Replaced the compressor.',
        'maintenance.gmOnly': 'Only a manager can close a ticket.',
        'settings.desktopNotifications.title': 'Desktop Notifications',
        'settings.desktopNotifications.label': 'Send notifications to the desktop',
        'settings.desktopNotifications.on': 'A desktop notification is shown for anything new.',
        'settings.desktopNotifications.off': 'Off. Notifications are only visible inside the app.',
        'settings.desktopNotifications.willAsk': 'The browser will ask for permission when you turn this on.',
        'settings.desktopNotifications.blocked': 'The browser is not allowing these notifications.',
        'settings.desktopNotifications.blockedHint': 'Allow notifications for this site in your browser settings, then try again.',
        'settings.desktopNotifications.unsupported': 'This browser does not support desktop notifications.',
        'notifications.duePayments.title': 'Sale awaiting payment',
        'notifications.duePayments.room': 'room {room}',
        'notifications.duePayments.amount': '{amount} {currency} not collected',
        'notifications.upcomingSaleReminder.title': 'Upcoming Sale / Transfer Reminder',
        'notifications.upcomingSaleReminder.content': 'Scheduled for tomorrow: {name} · Room: {room} · Guest: {guest} · Time: {time}',
        ...
        'personalNotes.desc': 'Keep your ideas, tag them, and share them with the teammates you pick.',
        'personalNotes.add': 'Add New Note',
        'personalNotes.create': 'Create New Note',
        'personalNotes.edit': 'Edit Note',
        'personalNotes.form.title': 'Title',
        'personalNotes.form.body': 'Note',
        'personalNotes.form.tags': 'Tags',
        'personalNotes.form.tagsHint': 'Separate tags with commas.',
        'personalNotes.share': 'Edit Together',
        'personalNotes.shareHint': 'The people you pick can view and edit this note.',
        'personalNotes.ownBadge': 'Personal Note',
        'personalNotes.sharedBadge': 'Shared Note',
        'personalNotes.preview': 'Note Length',
        'personalNotes.unitWords': 'words',
        'personalNotes.unitChars': 'characters',
        'personalNotes.noBody': 'No content',
        'personalNotes.clickToEdit': 'Click the card to edit it.',
        'personalNotes.updated': 'Updated',
        'personalNotes.created': 'Created',
        'personalNotes.empty': 'No notes in this view.',
        'personalNotes.createFirst': 'Create the first one',
        'personalNotes.viewActive': 'My notes',
        'personalNotes.viewShared': 'Shared',
        'personalNotes.viewArchived': 'Archive',
        'personalNotes.viewTrash': 'Trash',
        'personalNotes.search': 'Search notes',
        'personalNotes.searchPlaceholder': 'Search title, text, or tags',
        'personalNotes.allTags': 'All tags',
        'personalNotes.copyBody': 'Copy content',
        'personalNotes.copied': 'Note content copied.',
        'personalNotes.copyFailed': 'Could not copy.',
        'personalNotes.archive': 'Archive',
        'personalNotes.unarchive': 'Unarchive',
        'personalNotes.moveToTrash': 'Delete',
        'personalNotes.restore': 'Restore',
        'personalNotes.purge': 'Delete forever',
        'personalNotes.unsaved': 'Unsaved changes',
        'personalNotes.allSaved': 'All changes saved',
        'personalNotes.saving': 'Saving',
        'personalNotes.saved': 'Note saved.',
        'personalNotes.saveFailed': 'Note could not be saved.',
        'personalNotes.createFailed': 'Note could not be created.',
        'personalNotes.updateFailed': 'Note could not be updated.',
        'personalNotes.deleteFailed': 'Note could not be deleted.',
        'personalNotes.loadFailed': 'Personal notes could not be loaded.',
        'personalNotes.sharedLoadFailed': 'Shared notes could not be loaded.',
        'personalNotes.demoBlocked': 'Personal notes are unavailable in demo mode.',
        'personalNotes.leaveConfirm': 'Discard your unsaved changes?',
        ...
        'ai.chat.internalWelcome': 'I have real-time access to your operational data (rosters, sales, handover notes, tours, and exchange rates). I can prepare operational reports, shift summaries, or analyze guest requests.',
        ...
        'announcement.withdraw': 'Withdraw',
        'announcement.withdrawConfirm': 'Remove this announcement from everyone\'s screen? Anyone who already read it is told it was withdrawn, and is reminded until they acknowledge it. Anyone who has not opened it yet is told nothing.',
        'announcement.withdrawn': 'Withdrawn',
        'announcement.withdrawnBy': 'Withdrawn by {name}',
        'announcement.restore': 'Publish again',
        'announcement.purge': 'Delete permanently',
        'announcement.purgeConfirm': 'Permanently delete this announcement and its read receipts? This cannot be undone.',
        'announcement.insights': 'Who has seen it?',
        'announcement.sentBy': 'Sent by',
        'announcement.notSeenYet': 'Not seen yet',
        'announcement.seen': 'Seen',
        'announcement.dismissed': 'Dismissed',
        'announcement.everyone': 'Everyone',
        'announcement.selectedCount': '{count} people',
