...
- Name: public-pages.spec.ts >> Public & Marketing Pages >> TC-PUB-002: Pricing page displays plan cards and handles cycle toggle
- Location: tests/e2e/public-pages.spec.ts:29:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/pricing
Call log:
  - navigating to "http://localhost:5174/pricing", waiting until "load"
