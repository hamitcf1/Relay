...
- Name: public-pages.spec.ts >> Public & Marketing Pages >> TC-PUB-004: Legal pages (Privacy & Terms) display complete policy titles
- Location: tests/e2e/public-pages.spec.ts:58:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/legal/privacy
Call log:
  - navigating to "http://localhost:5174/legal/privacy", waiting until "load"
